...
type SenderPostBodySlack struct {
	...
	Metadata       *SenderPostBodySlackMetadata `json:"metadata,omitempty"`
}
...
func (o *SenderPostBodySlack) GetMetadata() SenderPostBodySlackMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret SenderPostBodySlackMetadata
		return ret
	}
	return *o.Metadata
}
...
// and a boolean to check if the value has been set.
func (o *SenderPostBodySlack) GetMetadataOk() (*SenderPostBodySlackMetadata, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
// SetMetadata gets a reference to the given SenderPostBodySlackMetadata and assigns it to the Metadata field.
func (o *SenderPostBodySlack) SetMetadata(v SenderPostBodySlackMetadata) {
	o.Metadata = &v
}
